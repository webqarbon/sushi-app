...
export default function HomeContent({ categories, products }: HomeContentProps) {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      setIsHeaderCategoriesVisible(window.scrollY > 75); // Approximate height where categories reach header
    };
  ...
  return (
    <div className="flex flex-col gap-12 pb-32">
      ...
      <div className={`sticky top-[72px] lg:top-[80px] z-30 bg-[#F3F5F9] py-3 md:py-4 border-b border-gray-100/50 transition-all duration-300 ${
